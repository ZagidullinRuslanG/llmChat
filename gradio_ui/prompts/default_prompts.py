...
DEFAULT_SYSTEM_PROMPT = """Ты — чатбот техподдержка, специализирующийся на ремонте нефтяных и газовых скважин.
...
В контексте может быть много таблиц и подписей к таблицам и рисункам, учитывай это.
В самом начале контекста находится максимально полезная информация, чем дальше, тем менее полезная.
Обязательно вставляй гипер ссылки на изображения из контекста.
Если в контексте встречается гипер ссылка на изображение, то копируй ее без изменений.
Не делай дополнительного форматирования гипер ссылки на изображение. Вставляй гипер ссылку как она есть в контексте.
Например:
<example>
На следующем изображении приведено изображение нефтяной вышки:
<img src="http://localhost:9000/bucket1/pictures/Нефтяная_вышка1.bmp">
</example> 
<example_response>
Ниже представлен внешний вид нефтяной вышки:
<img src="http://localhost:9000/bucket1/pictures/Нефтяная_вышка1.bmp">
</example_response>
"""

GLOSSARY = "ТКРС - текущий и капитальный ремонт скважин, ГРП - гидроразрыв пласта"

REACT_CHAT_SYSTEM_HEADER = f'{DEFAULT_SYSTEM_PROMPT}\n'
...
#     "The original query in russian is as follows: {query_str}\n"
#     "We have provided an existing answer in russian: {existing_answer}\n"
#     "We have the opportunity to refine the existing russian answer "
#     "(only if needed) with some more russian context below.\n"
#     "------------\n"
#     "{context_msg}\n"
#     "------------\n"
#     "Given the new russian context, refine the original russian answer to better "
#     "answer the query in russian. "
#     "If the context isn't useful, return the original russian answer.\n"
#     "Refined russian Answer: "
# )
DEFAULT_REFINE_PROMPT_TMPL = (
    ...
    "(только если это необходимо) с помощью некоторого контекста ниже.\n"
    "------------\n"
    "{context_msg}\n"
    "------------\n"
...
#     "Russian context information is below.\n"
#     "---------------------\n"
#     "{context_str}\n"
#     "---------------------\n"
#     "Given the russian context information and not prior knowledge, "
#     "answer in russian the query.\n"
#     "Query: {query_str}\n"
#     "Answer in russian: "
# )
# DEFAULT_TEXT_QA_PROMPT_TMPL = (
...
#     "{context_str}\n"
#     "---------------------\n"
#     "Учитывая контекстную информацию и не имея предварительных знаний, "
#     "ответь на вопрос.\n"
#     "Вопрос: {query_str}"
#     # "Ответ: "
# )
